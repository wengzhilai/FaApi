...
return false;
        ...
        $.ajax({
            type: opts.method, url: opts.url, data: JSON.stringify(_92d), contentType: "application/json; charset=utf-8", dataType: "json", success: function (data) {
                if (data.success) {
                    var tmpData = { "total": data.total, "rows": data.dataList}
                    _92e(tmpData);
                    opts["msg"] = data.msg
                } else {
                    alert(data.msg)
